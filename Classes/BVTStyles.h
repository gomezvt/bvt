...
#define kMusic @[ @"Music Venues", @"Musicians", @"Musical Instruments & Teachers" ]

#define kHotelsHostelsBB @[ @"Hotels", @"Hostels", @"Bed & Breakfast" ]

#define kEntertainmentRecreation @[ @"Airsoft", @"Amusement Parks", @"Aquariums", @"Arcades", @"Archery", @"ATV Rentals/Tours", @"Badminton", @"Baseball Fields", @"Basketball Courts", @"Batting Cages", @"Beach Equipment Rentals", @"Beaches", @"Bike Rentals", @"Bingo Halls", @"Boating", @"Bocce Ball", @"Bowling", @"Bubble Soccer", @"Bungee Jumping", @"Carouses", @"Casinos", @"Cinema", @"Climbing", @"Country Clubs", @"Cultural Center", @"Cycling Classes", @"Disc Golf", @"Diving", @"Fishing", @"Boxing", @"Cardio Classes", @"Dance Studios", @"Farms", @"Go Karts", @"Golf", @"Gun/Rifle Ranges", @"Gymnastics", @"Gyms", @"Hiking", @"Horseback Riding", @"Hot Air Balloons", @"Jet Skis", @"Kids Activities", @"Lakes", @"Martial Arts", @"Medication Centers", @"Mini Golf", @"Mountain Biking", @"Opera & Ballet", @"Paddleboarding", @"Paintball", @"Parks", @"Planetarium", @"Psychics & Astrologers", @"Laser Tag", @"Race Tracks", @"Rafting/Kayaking", @"Recreation Centers", @"Rock Climbing", @"Sailing", @"Skating Rinks", @"Skydiving", @"Sledding", @"Soccer", @"Social Clubs", @"Stadiums & Arenas", @"Surfing", @"Swimming Pools", @"Tennis", @"Tubing", @"Water Parks", @"Wineries", @"Yoga", @"Ziplining", @"Zoos"]
